...
def go(config: DictConfig):
    ...
    if isinstance(config["main"]["execute_steps"], str):
        ...
        # this from the original code does not work since the instance 
        # is not a python list but a ListConfig object
    ...
    if "check_data" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "ks_alpha": str(config["data"]["ks_alpha"])
            },
        )
    ...
    if "segregate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "stratify": str(config["data"]["stratify"])
            },
        )
    ...
    if "random_forest" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "random_seed": str(config["main"]["random_seed"]),
    ...
    if "evaluate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "model_export": "random_forest_model.pkl:latest",
